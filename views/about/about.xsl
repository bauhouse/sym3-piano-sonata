		...
		<div id="content" class="col span-9">
			...
			<div class="span-9">
				<div class="last span-7 nudge-2 make-message">
					<h4>Notes</h4>	
					<p>It's preferred to use the contact form rather than email. There is always a chance for emails to be picked up as spam. I will generally reply to messages within 24 hours unless I am horribly swamped.</p>
				</div>
			</div>
			<div class="span-9">
